...
//            $andwhere=" and supplier_name like '%{$supplier_name}%'";
        }
...
//        $bc_id = RequestHelper::post('bc_id',0,'intval');
...
//            var_dump($supplier_goods_info);exit;
...
//            $goods[$k]['attribute'] = $supplier_goods_info['attribute'];
...
//            $where.=" and company_name ='".$company_name ."'";
    ...
    public function actionGoodsList(){
        ...
        if($sp_id){
            ...
            $and_where = array();
            if($goods_name){
//                $and_where.=" and title like '%$goods_name%' ";
