...
<!--        </tr>-->
        ...
        <tr>
            ...
            <td><img src="<?= \Yii::$app->params['image'].$list['image'];?>" style="max-height: 200px;max-height: 200px"> </td>
        </tr>
        ...
        <tr >
            ...
            <td style="text-align: left;">
                ...
                <img src="<?= \Yii::$app->params['image'].$data['image'];?>" style="max-height: 200px;max-height: 200px;margin-left: 20px; margin-top: 20px;">
                <?php endforeach;?>
                </td>
        </tr>
        <?php endif;?>
