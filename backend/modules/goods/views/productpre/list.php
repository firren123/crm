...
<legends  style="fond-size:12px;">
    <ul class="breadcrumb">
        ...
        <li class="active">待发布商品图片管理</li>
    </ul>
</legends>
<a id="yw0" class="btn btn-primary" href="/goods/productpre/save?id=<?= RequestHelper::get('id')?>" style="margin-bottom:20px;">添加图片</a>
