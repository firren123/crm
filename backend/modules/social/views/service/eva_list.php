...
<div class="wide form">
    <form id="search-form" class="well form-inline" action="/social/service/eva-list" method="get">
                ...
                <?php if(empty($list)) {
                    ...
                    foreach($list as $item){
                        ...
                        <tr>
                            ...
                            <td colspan="2"><?= $item['star'];?></td>
                            <td colspan="2"><?= mb_substr($item['content'], 0, 2, 'utf-8');?>...</td>
                            <td colspan="2"><?= $item['type']==1?'体验方':'服务方';?></td>
                            <td colspan="2"><?= $item['create_time'];?></td>
                            <td colspan="4">
                                <a href="<?= '/social/service/eva-detail?id='.$item['id'];?>">详情</a>
