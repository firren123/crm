...
<head>
    ...
    <title>i500在线客服</title>
    <script type="text/javascript" src="/js/social/webim/easymob-webim1.0/jquery-1.11.1.js"></script>
    <script type="text/javascript" src="/js/social/webim/easymob-webim1.0/strophe-custom-2.0.0.js"></script>
    <script type="text/javascript" src="/js/social/webim/easymob-webim1.0/json2.js"></script>
    <script type="text/javascript" src="/js/social/webim/easymob-webim1.0/easemob.im-1.0.5.js"></script>
    <script type="text/javascript" src="/js/social/webim/easymob-webim1.0/bootstrap.js"></script>
    <link rel="stylesheet" type="text/css" href="/js/social/webim/easymob-webim1.0/css/webim.css" />
    <link rel="stylesheet" type="text/css" href="/js/social/webim/easymob-webim1.0/css/bootstrap.css" />
        <script type="text/javascript">
            var baseUrl = "/js/social/webim/easymob-webim1.0/";
            var apiURL = null;
            var curUserId = null;
...
//		conn.context.accessToken ='YWMtHGzBdDQSEeWTdPvH_-23UQAAAVACnE5Z9UxLmv6UlQkzcF0op_l28uJUEWM';
                //初始化连接
                conn.init({
                    https : false,
                    //当连接成功时的回调方法
                ...
                for (var i = 0; i < rosterMsg.length; i++) {
                    ...
                    if (contact.subscription == 'both') {
                        ...
                        if (!isexist) {
                            ...
                            $('<img>').attr({
                                "src" : baseUrl+"img/head/contact_normal.png"
                            }).appendTo(lielem);
...
//			pwd : pass,
            ...
            var buildContactDiv = function(contactlistDivId, roster) {
                ...
                for (i = 0; i < roster.length; i++) {
                    ...
                    $('<img>').attr("src", baseUrl+"img/head/contact_normal.png").appendTo(
                        lielem);
            ...
            var buildListRoomDiv = function(contactlistDivId, rooms) {
                ...
                for (i = 0; i < rooms.length; i++) {
                    ...
                    $('<img>').attr({
                        'src' : baseUrl+'img/head/group_normal.png'
                    }).appendTo(lielem);
            ...
            var createMomogrouplistUL = function createMomogrouplistUL(who, message) {
                ...
                imgelem.setAttribute("src", baseUrl+"img/head/contact_normal.png");
...
<!--    </div>-->
    ...
    <div id="waitLoginmodal" class="modal hide fade" data-backdrop="static">
        <img src="/js/social/webim/easymob-webim1.0/img/waitting.gif">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;正在努力加载中...</img>
    </div>
    <div class="content" id="content" style="display: none">
        <div class="leftcontact" id="leftcontact">
            <div id="headerimg" class="leftheader">
				<span> <img src="/js/social/webim/easymob-webim1.0/img/head/header2.jpg" alt="logo"
        ...
        <div class="chatRight">
                ...
                <div class="chat01_title">
                    <ul class="talkTo">
                        ...
                        <li id="recycle" style="float: right;"><img
                                src="/js/social/webim/easymob-webim1.0/img/recycle.png" onclick="clearCurrentChat();"
                                style="margin-right: 15px; cursor: hand; width: 18px;" title="清屏" /></li>
                        <li id="roomInfo" style="float: right;"><img
                                id="roomMemberImg"
                                src="/js/social/webim/easymob-webim1.0/img/head/find_more_friend_addfriend_icon.png"
            ...
            <div class="chat02">
                ...
                <div class="chat02_bar">
                    <ul>
                        <li style="right: 5px; top: 5px;"><img src="/js/social/webim/easymob-webim1.0/img/send_btn.jpg"
                                                               onclick="sendText()" /></li>
                    </ul>
                </div>
