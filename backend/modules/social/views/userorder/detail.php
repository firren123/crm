...
<div class="content fr">
            ...
            <li>
                <dl>
                    ...
                    <dd><span class="user_value" id="val_consignee"><?php echo $order_info['consignee']; ?></span>
                        ...
                        <p class="user_input" style="display:none;">
                            <input type="text" id="input_consignee" class="input_user_value form-control" size="20"
                                   value="<?php if (isset($order_info['consignee'])) {
                                       echo $order_info['consignee'];
                                   } ?>"/>
                        </p>
                    </dd>
                </dl>
                <dl>
                    ...
                    <dd>
                        ...
                        <p class="user_input" style="display:none;">
                            <input type="text" id="input_mobile" class="input_user_value form-control" size="20"
                                   value="<?php if (isset($order_info['mobile'])) {
                                       echo $order_info['mobile'];
                                   } ?>"/>
                        </p>
                    </dd>
                </dl>
            ...
            <li>
                <dl>
                    ...
                    <dd>
                        ...
                        <p class="user_input" style="display:none;">
                            <input type="text" id="input_address" class="input_user_value form-control" size="60"
                                   value="<?php if (isset($order_info['address'])) {
                                       echo $order_info['address'];
                                   } ?>"/>
                        </p>
                    </dd>
                </dl>
        ...
        <ul>
            ...
            <li>
                <dl>
                    <dt>物流状态：</dt>
                    <dd><?php
                        if (isset($ship_status_data[$order_info['ship_status']])) {
                            echo $ship_status_data[$order_info['ship_status']];
                        }
                        ?>
                        <input type="hidden" value="<?= $order_info['ship_status']; ?>" id="order_info_ship_status"/>
                    </dd>
                </dl>
                <dl>
                    <dt>确认状态：</dt>
        ...
        <ul>
            <li>
                <dl>
                    <dt>支付方式：</dt>
                    <dd><?php
                        if ($order_info['pay_method_id']) {
                            echo isset($pay_type_data[$order_info['pay_method_id']]) ? $pay_type_data[$order_info['pay_method_id']] : '其他';
                        }
                        ?></dd>
                </dl>
                <dl>
            ...
            <tr>
                <td class="tdbox">
                    <dl class="commoditybox">
                        <dt>
                            <a href="<?= Yii::$app->params['pc_mall'] . '/goods/details/' . $order_info['shop_id'] . '/' . $a_product_info['product_id']; ?>">
                                <img src="<?= Yii::$app->params['imgHost'] . $a_product_info['product_img'] ?>"></a>
                        </dt>
                        <dd>
                            <a href="<?= Yii::$app->params['pc_mall'] . '/goods/details/' . $order_info['shop_id'] . '/' . $a_product_info['product_id']; ?>"><?php echo $a_product_info['product_name']; ?></a>
                        </dd>
                    </dl>
                </td>
                <td>
        ...
        <div class="row-fluid">
            ...
            <table class="table table-bordered table-hover">
                ...
                <?php if ($order_info['status'] == 0) { ?>
                    <?php $form = ActiveForm::begin(['id' => 'login-form', 'action' => '/social/userorder/edits',]); ?>
                    <tr>
                    ...
                    <?php ActiveForm::end(); ?>
                <?php } ?>
                <?php if ($order_info['ship_status'] < 2 && $order_info['status'] == 1) { ?>
    ...
    <!--确认收货 去付款-->
    <a href="/social/userorder/index" class="btn waitbtn btn-primary">取&nbsp;&nbsp;&nbsp;&nbsp;消</a>
