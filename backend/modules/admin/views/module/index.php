...
<div class="wide form">
    <form id="search-form" class="well form-inline" action="/admin/module/index" method="get">
...
<a id="yw0" class="btn btn-primary" href="/admin/module/add" style="margin-bottom:20px;">添加模块</a>
            ...
            <?php if(empty($list)) {
                ...
                foreach ($list as $item):
                    ...
                    <tr>
                        ...
                        <td><?= $item['sort'];?></td>
                        <td><a style="cursor:pointer" onclick="Delete(<?= $item['id'];?>)">删除</a> | <a style="cursor:pointer" href="/admin/module/edit?id=<?= $item['id'];?>">修改</a> </td>
                    </tr>
                <?php endforeach;
            }
            ?>
