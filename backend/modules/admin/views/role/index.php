...
<div class="wide form">
    <form id="search-form" class="well form-inline" action="/admin/role/index" method="get">
...
<a id="yw0" class="btn btn-primary" href="/admin/role/add" style="margin-bottom:20px;">添加角色</a>
                ...
                foreach ($list as $item):
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a style="cursor:pointer" href="/admin/role/edit?id=<?= $item['id'];?>">修改</a>|
                            <a style="cursor:pointer" href="/admin/auth/index?id=<?= $item['id'];?>">分配权限</a>
                        </td>
                    </tr>
                <?php endforeach;
            }
