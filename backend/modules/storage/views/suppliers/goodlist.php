    ...
    <div class="tab-content">
        <div class="row-fluid">
            <table  class="table table-bordered table-hover">
                ...
                <?php if(empty($data)) {
                    echo '<tr><td colspan="4" style="text-align:center;">暂无记录</td></tr>';
                }else{
                    foreach($data as $item):?>
                        <tr>
                            <td class="goodid" style="text-align:center;"><?=$item['id']?></td>
                            <td class="goodname" style="text-align:center;"><?=$item['name']?></td>
                            ...
                            <td class="bar_code" style="display: none"><?=$item['bar_code']?></td>
                            <td style="text-align:center;">
