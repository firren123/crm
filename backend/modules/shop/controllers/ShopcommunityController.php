...
//        if (!empty($item)) {
//            foreach ($item as $k => $v) {
//                if (array_key_exists($v['community_id'], $rs_have)){
//                    unset($item[$k]);
//                }
//            }
//        }
            //$rs_html = $model->createHtml($rs, $rs_have);
//        var_dump($item);
//        var_dump($rs_have);exit();
//            $params = ['item'=>$item, 'have'=>$rs_have];
//            return $this->render('list', $params);
            ...
            //$info = Shop::findOne($shop_id);
//            $url = 'i500/shops/'.$shop_id;
//            $res = CurlHelper::get($url, 'api');


            //var_dump($info);
//            $province = CommonHelper::province();
//            $city = CommonHelper::city();
//            $district = CommonHelper::district();
            //var_dump($district);
            $params = [
                'info'=>$info,
                'community'=>$item,
                'have'=>$rs_have,
//                'province'=>ArrayHelper::getValue($province, $info['province']),
//                'city'=>ArrayHelper::getValue($city, $info['city']),
//                'district'=>ArrayHelper::getValue($district, $info['district']),
            ];
