...
<div class="wide form">
    <form id="search-form" class="well form-inline" action="/user/userorder/index" method="get">
                ...
                <?php if(empty($data)) {
                    ...
                    foreach($data as $item){
                        ...
                        <tr <?php if(in_array($item['id'],$result_arr)):?>bgcolor="#aaaaaa" <?php endif;?>>
                            <td colspan="2"><a href="<?= '/user/userorder/detail?order_sn='.$item['order_sn'];?>"><?= $item['order_sn'];?></a></td>
                            <td colspan="2"><a href="/user/user/showoneuser?id=<?= $item['user_id']?>" target="_blank"><?= $item['username'];?></a></td>
                            ...
                            <td colspan="2"><?php if(isset($pay_size_id[$item['pay_site_id']])){echo $pay_size_id[$item['pay_site_id']];}else{echo '未知';};?></td>
