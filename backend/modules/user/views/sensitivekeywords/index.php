...
<legends  style="fond-size:12px;">
    <legend>敏感词管理</legend>
    <a id="yw0" class="btn btn-primary" href="/user/sensitivekeywords/add" style="margin-bottom:20px;">添加敏感词</a>
                ...
                <?php if(empty($info)) {
                    ...
                    foreach($info as $item){
                        ...
                        <tr>
                            ...
                            <td colspan="3"><a onclick="return confirm('确认删除吗？');" href="/user/sensitivekeywords/del?id=<?php echo $item['id'];?>">删除敏感词</a>
