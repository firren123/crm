...
class BaseRequestHelps
{
     ...
     * @param string $_String x
     * @param string $_Code   x
     * @return mixed
     */
    public static function Pinyin($_String, $_Code = 'GBK')
    {
        ...
        $info = preg_replace("/[^a-z0-9]*/", '', $_Res); // 排除过滤除小写英文和数字以为的字符
        return $info;
    }
